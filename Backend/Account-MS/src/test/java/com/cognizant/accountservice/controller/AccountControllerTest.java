...
class AccountControllerTest {
	...
	void getAccountTest() throws Exception {
		...
		mockMvc.perform(get("/account-ms/getAccount/1").header("Authorization", "token")).andExpect(status().isOk());
	...
	void getCustomerAccountTest() throws Exception {
		...
		mockMvc.perform(get("/account-ms/getAccounts/cust01").header("Authorization", "token")).andExpect(status().isOk());
	...
	void createAccountTest() throws Exception {
		...
		.post("/account-ms/createAccount/Cust101")
...
//	}
	...
	void  getAllAccountTest() throws Exception  {
		...
		mockMvc.perform(get("/account-ms/find").header("Authorization", "token")).andExpect(status().isOk());
