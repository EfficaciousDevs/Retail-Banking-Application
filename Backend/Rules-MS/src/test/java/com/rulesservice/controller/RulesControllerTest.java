...
class RulesControllerTest {
	...
	void evaluateTest() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.post("/rules/evaluateMinBal").content(asJsonString(inp))
	...
	void serviceChargesTestNegative() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.post("/rules/serviceCharges").header("Authorization", "token"))
	...
	@Test
	 void MinimumBal() throws MinimumBalanceException, Exception {
